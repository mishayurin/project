...
class _ProfilePageState extends State<ProfileScreen> {
  TextEditingController _email =
      TextEditingController(text: "a.ivanova@mail.ru");
  TextEditingController dateOfBirth = TextEditingController(text: "04-19-1992");
  TextEditingController password = TextEditingController(text: "+7 (495) 649-22-16");
  @override
              ...
              children: [
                ...
                TextField(
                  ...
                  style: TextStyle(
                      fontSize: 17, fontWeight: FontWeight.bold, color: black),
                  decoration: InputDecoration(
                      hintText: "Пароль", border: InputBorder.none),
                ),
              ],
            ),
          )
